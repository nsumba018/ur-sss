      ...
      <section className="relative overflow-hidden bg-ur-green-primary py-20 text-white">
        ...
        <div className="section-container relative z-10">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <span className="mb-4 inline-block text-xs font-bold uppercase tracking-[0.18em] text-white/60">Directorates</span>
            <h1 className="text-4xl font-extrabold leading-tight sm:text-5xl">The Five Core Directorates</h1>
